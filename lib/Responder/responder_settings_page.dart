...
class ResSettingsPage extends StatefulWidget {
  const ResSettingsPage({Key? key}) : super(key: key);
  @override
  State<ResSettingsPage> createState() => _ResSettingsPageState();
}

class _ResSettingsPageState extends State<ResSettingsPage> {
  @override
  void initState() {
    getUserData();
    getConnectivity();
